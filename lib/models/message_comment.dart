...
class MessageComment {
  ...
  /* MessageComment.fromMap(Map<String, dynamic> map) {
    Comment = map[MessageCommentFieldNames.Comment];
    ReplyFrom = map[MessageCommentFieldNames.ReplyFrom];
    ReplySentOn = DateTime.parse(map[MessageCommentFieldNames.ReplySentOn]);
  }*/

  factory MessageComment.fromJson(Map<String, dynamic> parsedJson) {
    return MessageComment(
      Comment: parsedJson[MessageCommentFieldNames.Comment] ??
          StringHandlers.NotAvailable,
      ReplyFrom: parsedJson[MessageCommentFieldNames.ReplyFrom] ?? '',
