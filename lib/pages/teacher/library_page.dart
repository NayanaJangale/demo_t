...
import 'package:teachers/components/custom_library_item.dart';
...
import 'package:teachers/models/library_author.dart';
import 'package:teachers/models/library_book_details.dart';
import 'package:teachers/models/library_publication.dart';
import 'package:teachers/models/library_title.dart';
    ...
    try {
      ...
      if (connectionServerMsg != "key_check_internet") {
        Uri fetchBookDetailsUri = NetworkHandler.getUri(
          ...
          {
            'emp_no': AppData.getCurrentInstance().user.emp_no.toString(),
